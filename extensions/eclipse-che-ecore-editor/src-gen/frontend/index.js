...
module.exports = Promise.resolve()
    ...
    .then(function () { return import('theia-glsp/lib/theia/diagram-module').then(load) })
    .then(function () { return import('glsp-theia-extension/lib/browser/frontend-extension').then(load) })
    .then(function () { return import('theia-ecore/lib/browser/frontend-extension').then(load) })
